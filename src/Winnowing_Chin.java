...
final class MyResult_Chin {
    private final float first;
    private final ArrayList<long[]> second;

    public MyResult_Chin(float first, ArrayList<long[]> second) {
        this.first = first;
        this.second = second;
    }
...
//        System.out.println(hash);
    ...
    public static String preprocess_text(String x) {
        ...
        String txt = x.replaceAll("[^\\u4e00-\\u9fa5]", "").replaceAll("[^\\p{L}\\p{Nd}]+","").replaceAll("[0-9]","").replaceAll("[a-zA-Z]", "");
...
//
//        }
    public static ArrayList<long[]> Winnowing_Chin(String txt) {
...
//            }
    ...
    public static MyResult_Chin similarity(ArrayList<long[]> txt1Hash, ArrayList<long[]> txt2Hash){
        int i = 0;
        int j = 0;
        ...
        MyResult_Chin result = new MyResult_Chin(2*(float)matchingHash.size()/(txt1Hash.size()+txt2Hash.size()),matchingHash);
...
//        }
    public static void main(String[] args) {
        String text1 ="好好学习天天向上";
        String text2 = "好好学习天天向上";
//            String text2 = text1;
...
//            String text2 = "froggie im rabbiee i like dazhonghua";
        ...
        ArrayList<long[]> fp1 = Winnowing_Chin(text1);
        ArrayList<long[]> fp2 = Winnowing_Chin(text2);
        float similar = similarity(fp1, fp2).getFirst();
        ArrayList<long[]> matchingHash = similarity(fp1, fp2).getSecond();
        System.out.print("aaaaa"+Arrays.deepToString(matchingHash.toArray())+ similar);
...
//                    continue;
//                }
//                ArrayList<long[]> fp1 = Winnowing_Chin(textArr.get(17), t, k);
...
//                    ArrayList<long[]> fp2 = Winnowing_Chin(textArr.get(j), t, k);
